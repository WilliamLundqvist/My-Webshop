    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-surface p-4 rounded mb-6">
        ...
        <ul className="list-disc pl-5">
          <li className="mb-2">
            <strong>WORDPRESS_URL (env):</strong> {process.env.NEXT_PUBLIC_WORDPRESS_URL || 'Not set'}
          </li>
          <li className="mb-2">
      ...
      <div className="bg-surface p-4 rounded mb-6">
        ...
        <ol className="list-decimal pl-5 mt-2">
          ...
          <li className="mb-1">Use fetchPolicy: 'network-only' in your GraphQL queries</li>
      ...
      <div className="alert alert-info p-4 bg-info/10 text-info rounded border border-info/30">
        ...
        <ol className="list-decimal pl-5 mt-2">
          ...
          <li className="mb-1">Run <code className="bg-surface px-1 py-0.5 rounded">node clear-cache.js</code></li>
